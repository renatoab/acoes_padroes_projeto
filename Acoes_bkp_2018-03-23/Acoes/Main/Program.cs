...
namespace Acoes
{
    ...
    {        
        ...
        static void Main()
        {
            ...
            Console.WriteLine("-> O Bridge é utilizado de forma que haja 2 implementações de interface do usuário:");
            Console.WriteLine("   uma Windows Forms e outra Console Application");
